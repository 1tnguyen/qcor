namespace Quantum.staq {
    ...
    operation Circuit() : Unit {
        using (qubits = Qubit[15]) {
            ...
            CCNOT(qubits[5], qubits[6], qubits[7]);
            CCNOT(qubits[10], qubits[11], qubits[12]);
            CNOT(qubits[1], qubits[2]);
            CNOT(qubits[3], qubits[4]);
            CNOT(qubits[5], qubits[6]);
            CNOT(qubits[7], qubits[9]);
            CNOT(qubits[10], qubits[11]);
            CNOT(qubits[12], qubits[14]);
            CNOT(qubits[2], qubits[3]);
            CNOT(qubits[11], qubits[13]);
            CCNOT(qubits[4], qubits[6], qubits[9]);
            CCNOT(qubits[3], qubits[6], qubits[7]);
            CCNOT(qubits[9], qubits[11], qubits[14]);
            CCNOT(qubits[7], qubits[11], qubits[12]);
            ...
            CCNOT(qubits[0], qubits[12], qubits[14]);
            CCNOT(qubits[0], qubits[11], qubits[13]);
            CCNOT(qubits[0], qubits[6], qubits[8]);
            CNOT(qubits[14], qubits[12]);
            CNOT(qubits[13], qubits[11]);
            CNOT(qubits[8], qubits[6]);
