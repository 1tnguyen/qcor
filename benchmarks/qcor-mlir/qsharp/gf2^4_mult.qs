namespace Quantum.staq {
    ...
    operation Circuit() : Unit {
        using (qubits = Qubit[12]) {
            CCNOT(qubits[3], qubits[5], qubits[8]);
            CCNOT(qubits[2], qubits[6], qubits[8]);
            CCNOT(qubits[1], qubits[7], qubits[8]);
            CCNOT(qubits[3], qubits[6], qubits[9]);
            CCNOT(qubits[2], qubits[7], qubits[9]);
            CCNOT(qubits[3], qubits[7], qubits[10]);
            CNOT(qubits[10], qubits[11]);
            CNOT(qubits[9], qubits[10]);
            CNOT(qubits[8], qubits[9]);
            CCNOT(qubits[3], qubits[4], qubits[11]);
            CCNOT(qubits[2], qubits[5], qubits[11]);
            CCNOT(qubits[1], qubits[6], qubits[11]);
            CCNOT(qubits[0], qubits[7], qubits[11]);
            CCNOT(qubits[2], qubits[4], qubits[10]);
            CCNOT(qubits[1], qubits[5], qubits[10]);
            CCNOT(qubits[0], qubits[6], qubits[10]);
            CCNOT(qubits[1], qubits[4], qubits[9]);
            CCNOT(qubits[0], qubits[5], qubits[9]);
