namespace Quantum.staq {
    ...
    operation Circuit() : Unit {
        using (qubits = Qubit[11]) {
            CCNOT(qubits[1], qubits[3], qubits[4]);
            X(qubits[4]);
            X(qubits[5]);
            ...
            X(qubits[6]);
            CCNOT(qubits[4], qubits[5], qubits[6]);
            CCNOT(qubits[10], qubits[9], qubits[8]);
            X(qubits[5]);
            X(qubits[4]);
            CCNOT(qubits[1], qubits[3], qubits[4]);
            ...
            CCNOT(qubits[4], qubits[5], qubits[6]);
            X(qubits[6]);
            CCNOT(qubits[6], qubits[8], qubits[7]);
            X(qubits[6]);
            CCNOT(qubits[4], qubits[5], qubits[6]);
            X(qubits[4]);
            CCNOT(qubits[4], qubits[8], qubits[5]);
            CCNOT(qubits[2], qubits[3], qubits[4]);
            CCNOT(qubits[2], qubits[8], qubits[3]);
            X(qubits[2]);
            CCNOT(qubits[0], qubits[1], qubits[2]);
            X(qubits[0]);
            CCNOT(qubits[0], qubits[8], qubits[1]);
            X(qubits[0]);
            CCNOT(qubits[10], qubits[9], qubits[8]);
